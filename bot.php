...
- 𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒅 𝒃𝒚 𝑀𝒶𝓍 ، 𝒵𝒶𝒶𝓀 🇪🇬 @Turbo_ismax .
",'parse_mode' => "MarkDown", 'disable_web_page_preview' => true,
'reply_markup' => json_encode(['inline_keyboard' => [
[['text' => "-𝑀𝒶𝓍 '", 'url' => "https://t.me/z_v_o"]],
[['text' => "-𝒵𝒶𝒶𝓀'", 'url' => "https://t.me/Xx_ZaaK"]],
]]) 
]);
}
...
if ($text == "->") {
bot('sendMessage', ['chat_id' => $chat_id, 'text' => "𝒘𝒆𝒍𝒄𝒐𝒎𝒆 , \n𝒊𝒏 𝒕𝒉𝒆 𝒄𝒉𝒆𝒄𝒌𝒆𝒓 𝒖𝒔𝒆𝒓 𝒏𝒂𝒎𝒆 𝒕𝒆𝒍𝒆𝒈𝒓𝒂𝒎 \n𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒅 𝒃𝒚 𝑀𝒶𝓍 ، 𝒵𝒶𝒶𝓀 🇪🇬 @Turbo_ismax . ", 'reply_markup' => json_encode(['resize_keyboard' => true, 'keyboard' => [
[["text" =>"𖠜 Numbers"],["text" =>"𖠜 Requests"]],
[["text" =>"𖠜 Run"],["text" =>"𖠜 Stop"]],
[["text" =>"𖠜 Add Users"],["text" =>"𖠜 Delet User"]],
[["text" =>"𖠜 To Bot ↺ Band"]],
...
'text' => "𝒘𝒆𝒍𝒄𝒐𝒎𝒆 , \n𝒊𝒏 𝒕𝒉𝒆 𝒄𝒉𝒆𝒄𝒌𝒆𝒓 𝒖𝒔𝒆𝒓 𝒏𝒂𝒎𝒆 𝒕𝒆𝒍𝒆𝒈𝒓𝒂𝒎 \n𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒅 𝒃𝒚 𝑀𝒶𝓍 ، 𝒵𝒶𝒶𝓀 🇪🇬 @Turbo_ismax . ",
'reply_markup' => json_encode(['inline_keyboard' => [
[['text'=>"-𝑀𝒶𝓍 🇪🇬 '", 'url' => "https://t.me/z_v_o"],['text'=>"-𝒵𝒶𝒶𝓀'", 'url' => "https://t.me/Turbo_ismax"]],
]]) 
]);
unlink('mode');
}
...
'text'=>"⌁ Data Checker Band , king @Turbo_ismax 🐊",
'reply_markup'=>json_encode(['inline_keyboard'=>[
